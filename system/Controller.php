...
class Controller
{
    ...
    protected function validateDataErrores(array $data, $rules, array $messages = [], ?string $dbGroup = null): String
    {
        $this->setValidator($rules, $messages);

        $this->validator->run($data, null, $dbGroup);
        return implode(",",$this->validator->getErrors());//devolver los errores separado por comas
    }
