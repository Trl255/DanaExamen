                ...
                <div class="sidebar-user">
                    ...
                    <ul class="list-unstyled list-inline mb-0 mt-2">
                        <li class="list-inline-item">
                            <a href="users/editar?id=<?php echo $session->get('id');?>" class="" data-toggle="tooltip" data-placement="top" title="Profile"><i class="dripicons-user text-purple"></i></a>
                        </li>
                        <li class="list-inline-item">
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo baseUrl();?>" class="waves-effect">
                            ...
                            <li>
                                <a href="<?php echo baseUrl();?>/agencias" class="waves-effect">
                                    <i class="dripicons-device-desktop"></i>
                                    <span> Agencias <span class="badge badge-pill badge-primary float-right">7</span></span>
                                </a>
                            </li>
                            <?php if($session->get('role')=="Administrador"){?>
                            <li>
                                <a href="<?php echo baseUrl();?>/users" class="waves-effect"><i class="dripicons-to-do"></i><span> Usuarios </span></a>
                            </li>
                            <?php }?>
                            <li>
                                <a href="<?php echo baseUrl();?>/roles" class="waves-effect">
                                    <i class="dripicons-device-desktop"></i>
                                    <span> Roles <span class="badge badge-pill badge-primary float-right">7</span></span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="<?php echo baseUrl();?>/tipo_facturacion" class="waves-effect"><i class="dripicons-to-do"></i><span> Tipo facturación </span></a>
                            </li>
                            
                            <li>
                                <a href="<?php echo baseUrl();?>/comercios" class="waves-effect"><i class="dripicons-to-do"></i><span> Comercios </span></a>
                            </li>
                            <li>
                                <a href="<?php echo baseUrl();?>/clientes" class="waves-effect"><i class="dripicons-to-do"></i><span> Clientes </span></a>
                            </li>
