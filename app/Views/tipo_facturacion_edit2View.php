...
<html lang="en">
    ...
    <input type="text" class="form-control" id="tipo_facturacion" aria-describedby="tipo_facturacion" placeholder="tipo_facturacion"  name="tipo_facturacion" value="<?php echo $tipo["tipo_facturacion"];?>">
            ...
            submitHandler: function(form){
             ...
             let tipo_facturacion=$("#tipo_facturacion").val();
                              ...
                              $.ajax({
                                ...
                                url: "<?php echo baseUrl();?>/tipo_facturacion/actualizar",
                                dataType:"html",
